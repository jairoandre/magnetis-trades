...
/***/ function(module, exports, __webpack_require__) {
	...
	var _user$project$Types$Model = F4(
		function (a, b, c, d) {
			return {trades: a, lastKey: b, shareValue: c, loadingStyle: d};
		});
	var _user$project$Types$initModel = A4(
	...
	var _user$project$Types$Trade = F7(
		function (a, b, c, d, e, f, g) {
			return {valid: a, showMsg: b, date: c, fund_id: d, id: e, kind: f, shares: g};
		});
	var _user$project$Types$newTrade = A7(_user$project$Types$Trade, true, false, '', -1, -1, -1, 0);
	var _user$project$Types$Animate = function (a) {
		return {ctor: 'Animate', _0: a};
	};
	var _user$project$Types$KeyPressed = function (a) {
		return {ctor: 'KeyPressed', _0: a};
	};
	var _user$project$Types$ChangeKind = F2(
		function (a, b) {
			return {ctor: 'ChangeKind', _0: a, _1: b};
		});
	var _user$project$Types$TypeShares = F2(
		function (a, b) {
			return {ctor: 'TypeShares', _0: a, _1: b};
		});
	var _user$project$Types$TypeDate = F2(
		function (a, b) {
			return {ctor: 'TypeDate', _0: a, _1: b};
		});
	var _user$project$Types$TradeRemoved = function (a) {
		return {ctor: 'TradeRemoved', _0: a};
	};
	var _user$project$Types$RemoveTrade = function (a) {
		return {ctor: 'RemoveTrade', _0: a};
	};
	var _user$project$Types$AddTrade = {ctor: 'AddTrade'};
	var _user$project$Types$SaveNewTrades = function (a) {
		return {ctor: 'SaveNewTrades', _0: a};
	};
	var _user$project$Types$SaveTrades = {ctor: 'SaveTrades'};
	var _user$project$Types$TypeShareValue = function (a) {
		return {ctor: 'TypeShareValue', _0: a};
	};
	var _user$project$Types$ReceiveTrades = function (a) {
		return {ctor: 'ReceiveTrades', _0: a};
	};
	var _user$project$Types$FetchTrades = {ctor: 'FetchTrades'};

	var _user$project$Utils$dateToString = function (date) {
		var hour = _elm_lang$core$Basics$toString(
				...
				A2(
					...
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							day,
							A2(_elm_lang$core$Basics_ops['++'], 'T', hour))))));
	};
	var _user$project$Utils$currencyToFloat = function (input) {
		var dLen = 2;
		var onlyDigits = A2(_elm_lang$core$String$filter, _elm_lang$core$Char$isDigit, input);
		var result = function () {
			if (_elm_lang$core$Native_Utils.eq(dLen, 0)) {
				return onlyDigits;
			} else {
				var len = _elm_lang$core$String$length(onlyDigits);
				return A2(
					_elm_lang$core$Basics_ops['++'],
					A2(_elm_lang$core$String$dropRight, dLen, onlyDigits),
					A2(
						_elm_lang$core$Basics_ops['++'],
						'.',
						A2(_elm_lang$core$String$dropLeft, len - dLen, onlyDigits)));
			}
		}();
		return A2(
			_elm_lang$core$Result$withDefault,
			0,
			_elm_lang$core$String$toFloat(result));
	};
	var _user$project$Utils$addSeparator = F2(
		function (c, input) {
			var lPart = A2(_elm_lang$core$String$dropRight, 3, input);
			var separator = (_elm_lang$core$Native_Utils.cmp(
				_elm_lang$core$String$length(lPart),
				0) > 0) ? '.' : '';
			return _elm_lang$core$Native_Utils.eq(c, 0) ? input : A2(
				_elm_lang$core$Basics_ops['++'],
				A2(_user$project$Utils$addSeparator, c - 1, lPart),
				A2(
					_elm_lang$core$Basics_ops['++'],
					separator,
					A2(_elm_lang$core$String$right, 3, input)));
		});
	var _user$project$Utils$decimalSeparator = function (input) {
		return A2(
			_user$project$Utils$addSeparator,
			(_elm_lang$core$String$length(input) / 3) | 0,
			input);
	};
	var _user$project$Utils$formatCurrency = F2(
		function (prefix, input) {
			var parts = A2(_elm_lang$core$String$split, '.', input);
			var iPart = function () {
				var _p1 = _elm_lang$core$List$head(parts);
				if (_p1.ctor === 'Nothing') {
					return '';
				} else {
					return _p1._0;
			...
			var fPart = function () {
				var _p2 = _elm_lang$core$List$tail(parts);
				if (_p2.ctor === 'Nothing') {
					return '00';
				} else {
					...
					if (_p3.ctor === 'Nothing') {
						...
						return A2(
							...
							A2(
								...
								2 - _elm_lang$core$String$length(_p4),
								'0'));
					}
				}
			}();
			return A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					_user$project$Utils$decimalSeparator(iPart),
					A2(_elm_lang$core$Basics_ops['++'], ',', fPart)));
		});
	var _user$project$Utils$serverDateToBrazilianDate = F2(
		function (srvDate, lastKey) {
			var day = A2(
				_elm_lang$core$String$filter,
				_elm_lang$core$Char$isDigit,
				A3(_elm_lang$core$String$slice, 8, 10, srvDate));
			var dLen = _elm_lang$core$String$length(day);
			var month = A2(
				_elm_lang$core$String$filter,
				_elm_lang$core$Char$isDigit,
				A3(_elm_lang$core$String$slice, 5, 7, srvDate));
			var mLen = _elm_lang$core$String$length(month);
			var dStr = _elm_lang$core$Native_Utils.eq(dLen, 2) ? ((_elm_lang$core$Native_Utils.eq(lastKey, 8) && _elm_lang$core$Native_Utils.eq(mLen, 0)) ? day : A2(_elm_lang$core$Basics_ops['++'], day, '/')) : day;
			var year = A2(
				_elm_lang$core$String$filter,
				_elm_lang$core$Char$isDigit,
				A3(_elm_lang$core$String$slice, 0, 4, srvDate));
			var yLen = _elm_lang$core$String$length(year);
			var mStr = _elm_lang$core$Native_Utils.eq(mLen, 2) ? ((_elm_lang$core$Native_Utils.eq(lastKey, 8) && _elm_lang$core$Native_Utils.eq(yLen, 0)) ? month : A2(_elm_lang$core$Basics_ops['++'], month, '/')) : month;
			return A2(
				_elm_lang$core$Basics_ops['++'],
				dStr,
				A2(_elm_lang$core$Basics_ops['++'], mStr, year));
		});
	var _user$project$Utils$repeatSpaces = function (ammount) {
		return A2(_elm_lang$core$String$repeat, ammount, ' ');
	};
	var _user$project$Utils$brazilianDateToServerDate = function (brDate) {
		var year = A3(_elm_lang$core$String$slice, 6, 10, brDate);
		var yLen = _elm_lang$core$String$length(year);
		var month = A3(_elm_lang$core$String$slice, 3, 5, brDate);
		var mLen = _elm_lang$core$String$length(month);
		var day = A3(_elm_lang$core$String$slice, 0, 2, brDate);
		var dLen = _elm_lang$core$String$length(day);
		return A2(
			_elm_lang$core$Basics_ops['++'],
			year,
			A2(
				_elm_lang$core$Basics_ops['++'],
				_user$project$Utils$repeatSpaces(4 - yLen),
				A2(
					_elm_lang$core$Basics_ops['++'],
					'-',
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_user$project$Utils$repeatSpaces(2 - mLen),
							A2(
								_elm_lang$core$Basics_ops['++'],
								'-',
								A2(
									_elm_lang$core$Basics_ops['++'],
									day,
									_user$project$Utils$repeatSpaces(2 - dLen))))))));
	};

	var _user$project$Validation$validateTrades = F3(
		function (shares, lTrades, rTrades) {
			validateTrades:
			while (true) {
				var _p0 = _elm_lang$core$List$head(rTrades);
				if (_p0.ctor === 'Nothing') {
					return lTrades;
				} else {
					var _p1 = _p0._0;
					var newShares = _elm_lang$core$Native_Utils.eq(_p1.kind, 0) ? (shares + _p1.shares) : (shares - _p1.shares);
					if (_elm_lang$core$Native_Utils.cmp(newShares, 0) < 0) {
						return A2(
							_elm_lang$core$Basics_ops['++'],
							A2(
								_elm_lang$core$List$map,
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								{
									...
									_0: _elm_lang$core$Native_Utils.update(
										_p1,
										{valid: false, showMsg: true}),
									_1: {ctor: '[]'}
								},
								A2(_elm_lang$core$List$drop, 1, rTrades)));
					} else {
						var _v1 = newShares,
							_v2 = A2(
							_elm_lang$core$Basics_ops['++'],
							...
							_v3 = A2(_elm_lang$core$List$drop, 1, rTrades);
						shares = _v1;
						lTrades = _v2;
						rTrades = _v3;
						continue validateTrades;
					}
				}
			}
		});

	var _user$project$View$loadingDiv = function (model) {
		return A2(
			_elm_lang$html$Html$div,
			A2(
				_elm_lang$core$Basics_ops['++'],
				_mdgriffith$elm_style_animation$Animation$render(model.loadingStyle),
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('loading-div'),
					_1: {ctor: '[]'}
				}),
			{
				ctor: '::',
									...
									_1: {
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Carregando...'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
	...
	var _user$project$View$appHeader = function (model) {
		return A2(
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Magnetis Trades'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('A sample application coded with Elm and Bulma.'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
	...
	var _user$project$View$buttons = function (model) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
					...
					},
					{
						...
						_0: A2(
							_elm_lang$html$Html$button,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_user$project$Types$SaveTrades),
									_1: {ctor: '[]'}
								}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Salvar Movimentações'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$button,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_user$project$Types$FetchTrades),
										_1: {ctor: '[]'}
									}
								},
								{
	...
	var _user$project$View$shareValueInput = function (model) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Valor da Cota'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('input right-align'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$value(
											A2(
												_user$project$Utils$formatCurrency,
												'R$ ',
												_elm_lang$core$Basics$toString(model.shareValue))),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_user$project$Types$TypeShareValue),
											_1: {ctor: '[]'}
										}
									}
								},
	...
	var _user$project$View$icon = function (val) {
		return A2(
				...
				_0: A2(
					_elm_lang$html$Html$i,
					{
						...
						_0: _elm_lang$html$Html_Attributes$class(
							A2(_elm_lang$core$Basics_ops['++'], 'fa fa-', val)),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}),
				_1: {ctor: '[]'}
	...
	var _user$project$View$heroFoot = A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('tabs is-boxed is-medium'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
									...
									_0: A2(
										...
										},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _user$project$View$icon('list'),
													_1: {
														ctor: '::',
														_0: A2(
															_elm_lang$html$Html$span,
	...
	var _user$project$View$tradeToRow = F4(
		function (lastKey, shareValue, idx, trade) {
			var warnMessage = trade.showMsg ? {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$tr,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('warn-trade'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
							...
							},
							{
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html$text('Seu saldo está negativo.'),
											_1: {ctor: '[]'}
										}
									}),
								_1: {ctor: '[]'}
			...
			var validClass = trade.valid ? '' : ' warn-trade';
			var trClass = _elm_lang$core$Native_Utils.eq(trade.id, -1) ? 'new-trade' : '';
			var total = trade.shares * shareValue;
			var totalStr = A2(
				_user$project$Utils$formatCurrency,
				'R$ ',
				_elm_lang$core$Basics$toString(total));
			var tDate = A2(_user$project$Utils$serverDateToBrazilianDate, trade.date, lastKey);
			var onlyRead = !_elm_lang$core$Native_Utils.eq(trade.id, -1);
			var _p0 = function () {
				var _p1 = trade.kind;
				switch (_p1) {
					case 0:
						return {
							ctor: '_Tuple2',
							_0: '#70C800',
							_1: _user$project$View$icon('arrow-right')
						};
					case 1:
						return {
							ctor: '_Tuple2',
							_0: '#00B1DA',
							_1: _user$project$View$icon('arrow-left')
						};
					default:
						return {
							ctor: '_Tuple2',
				...
				_elm_lang$core$Basics_ops['++'],
				{
					...
					_0: A2(
						_elm_lang$html$Html$tr,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class(
								A2(_elm_lang$core$Basics_ops['++'], trClass, validClass)),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$td,
								{
									...
									_0: _elm_lang$html$Html_Attributes$style(
										{
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'color', _1: tColor},
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								},
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('control has-icon has-icon-right'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: A2(
													_elm_lang$html$Html$input,
													{
														...
														_1: {
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$placeholder('Data'),
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$value(tDate),
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$readonly(onlyRead),
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Events$onInput(
																				_user$project$Types$TypeDate(idx)),
																			_1: {
																				ctor: '::',
																				_0: A2(
																					_elm_lang$html$Html_Events$on,
																					'keydown',
																					A2(_elm_lang$core$Json_Decode$map, _user$project$Types$KeyPressed, _elm_lang$html$Html_Events$keyCode)),
																				_1: {ctor: '[]'}
																			}
																		}
																	}
													...
													_0: A2(
														_elm_lang$html$Html$select,
														{
															...
															_1: {
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$disabled(onlyRead),
																	_1: {
																		ctor: '::',
																		_0: A2(
																			_elm_lang$html$Html_Events$on,
																			...
																			A2(
																				_elm_lang$core$Json_Decode$map,
																				_user$project$Types$ChangeKind(idx),
														...
														},
														{
															...
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text('Movimentação'),
																	_1: {ctor: '[]'}
																}),
															_1: {
																ctor: '::',
																	...
																	_elm_lang$html$Html$option,
																	{
																		...
																		_1: {
																			...
																			_0: _elm_lang$html$Html_Attributes$selected(
																				_elm_lang$core$Native_Utils.eq(trade.kind, 0)),
																			_1: {ctor: '[]'}
																		}
																	},
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text('Aplicação'),
																		_1: {ctor: '[]'}
																	}),
																_1: {
																	ctor: '::',
																	_0: A2(
																		_elm_lang$html$Html$option,
																		{
																			...
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$selected(
																					_elm_lang$core$Native_Utils.eq(trade.kind, 1)),
																				_1: {ctor: '[]'}
																			}
																		},
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text('Retirada'),
																			_1: {ctor: '[]'}
																		}),
																	_1: {ctor: '[]'}
																}
												...
												_0: A2(
													_elm_lang$html$Html$input,
													{
														...
														_1: {
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$placeholder('Quantidade de cotas'),
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$value(
																		_elm_lang$core$Basics$toString(trade.shares)),
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Events$onInput(
																			_user$project$Types$TypeShares(idx)),
																		_1: {ctor: '[]'}
																	}
																}
															}
													...
													_0: A2(
														_elm_lang$html$Html$input,
														{
															...
															_1: {
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$placeholder('Valor por cota'),
																	_1: {
																		ctor: '::',
																		...
																		_1: {
																			...
																			_0: _elm_lang$html$Html_Attributes$value(
																				A2(
																					_user$project$Utils$formatCurrency,
																					'R$ ',
																					_elm_lang$core$Basics$toString(shareValue))),
																			_1: {ctor: '[]'}
																		}
																	}
																}
														...
														_0: A2(
															_elm_lang$html$Html$input,
															{
																...
																_1: {
																	...
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$placeholder('Valor total'),
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$disabled(true),
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$value(totalStr),
																				_1: {ctor: '[]'}
																			}
																		}
																	}
															...
															_0: A2(
																_elm_lang$html$Html$a,
																{
																	...
																	_0: _elm_lang$html$Html_Events$onClick(
																		_user$project$Types$RemoveTrade(idx)),
																	_1: {ctor: '[]'}
																},
																{
																	ctor: '::',
																	_0: _user$project$View$icon('times'),
																	_1: {ctor: '[]'}
																}),
															_1: {ctor: '[]'}
														}),
	...
	var _user$project$View$tradesTable = function (model) {
		var trades = _elm_lang$core$List$concat(
			A2(
				_elm_lang$core$List$indexedMap,
				A2(_user$project$View$tradeToRow, model.lastKey, model.shareValue),
				A3(
					_user$project$Validation$validateTrades,
					0,
					{ctor: '[]'},
					model.trades)));
		return A2(
								...
								_1: {
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('TIPO'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('QUANTIDADE DE COTAS'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('VALOR POR COTA (R$)'),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('VALOR TOTAL (R$)'),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
												...
												_0: A2(
													...
													},
													{
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onClick(_user$project$Types$AddTrade),
																_1: {ctor: '[]'}
															},
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text('INSERIR NOVA MOVIMENTAÇÃO'),
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
													}),
	...
	var _user$project$View$appBody = function (model) {
		return A2(
			_elm_lang$html$Html$section,
			{
				ctor: '::',
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$View$shareValueInput(model),
						_1: {
							ctor: '::',
							_0: _user$project$View$tradesTable(model),
							_1: {
								ctor: '::',
								_0: _user$project$View$buttons(model),
								_1: {ctor: '[]'}
							}
						}
					}),
	...
	var _user$project$View$appFooter = A2(
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _user$project$View$icon('code'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _user$project$View$icon('heart'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												...
												_1: {
													...
													_0: A2(
														...
														{ctor: '[]'},
														{
															...
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text('jairoandre'),
																	_1: {ctor: '[]'}
																}),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html$text('. Built with '),
														_1: {
															ctor: '::',
															_0: A2(
																_elm_lang$html$Html$a,
															...
															_1: {
																...
																_1: {
																	...
																	_0: A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$href('http://bulma.io'),
																			_1: {ctor: '[]'}
																		},
																		{
																			ctor: '::',
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$href('http://github.com/jairoandre/magnetis-trades'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _user$project$View$icon('github'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
	...
	var _user$project$View$view = function (model) {
		return A2(
			...
			{
				ctor: '::',
				_0: _user$project$View$loadingDiv(model),
				_1: {
					ctor: '::',
					_0: _user$project$View$appBody(model),
					_1: {
						ctor: '::',
						_0: _user$project$View$appFooter,
						_1: {ctor: '[]'}
					}
				}
			});
	...
	var _user$project$Rest$stringToFloat = function (str) {
		return A2(
			_elm_lang$core$Result$withDefault,
			0,
			_elm_lang$core$String$toFloat(str));
	};
	var _user$project$Rest$decodeTrade = A6(
		_elm_lang$core$Json_Decode$map5,
		A2(_user$project$Types$Trade, true, false),
			...
			_elm_lang$core$Json_Decode$oneOf(
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$core$Json_Decode$null(-1),
						_1: {ctor: '[]'}
					}
				})),
		...
		A2(
			_elm_lang$core$Json_Decode$field,
			'shares',
			A2(_elm_lang$core$Json_Decode$map, _user$project$Rest$stringToFloat, _elm_lang$core$Json_Decode$string)));
	var _user$project$Rest$customRequest = F4(
	...
	var _user$project$Rest$deleteTrade = function (id) {
		var url = A2(
			_elm_lang$core$Basics_ops['++'],
			'https://magnetis-trades.herokuapp.com/trades/',
			A2(
				_elm_lang$core$Basics_ops['++'],
		...
		return A2(
			...
			_user$project$Types$TradeRemoved,
			A4(
				_user$project$Rest$customRequest,
				'DELETE',
				url,
				{ctor: '[]'},
				_elm_lang$http$Http$emptyBody));
	};
	var _user$project$Rest$decodeTrades = _elm_lang$core$Json_Decode$list(_user$project$Rest$decodeTrade);
	var _user$project$Rest$tradeToJson = function (trade) {
		return _elm_lang$core$Json_Encode$object(
			{
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'date',
					_1: _elm_lang$core$Json_Encode$string(trade.date)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'kind',
						_1: _elm_lang$core$Json_Encode$int(trade.kind)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'shares',
							_1: _elm_lang$core$Json_Encode$float(trade.shares)
						},
						_1: {ctor: '[]'}
					}
				}
	...
	var _user$project$Rest$tradeValue = function (trades) {
		var tradesJson = A2(_elm_lang$core$List$map, _user$project$Rest$tradeToJson, trades);
		return _elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
				_0: {
					...
					_1: _elm_lang$core$Json_Encode$object(
						{
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'trades_attributes',
								_1: _elm_lang$core$Json_Encode$list(tradesJson)
							},
							_1: {ctor: '[]'}
						})
				},
	...
	var _user$project$Rest$saveNewTrades = function (trades) {
		var url = 'https://magnetis-trades.herokuapp.com/investments.json';
		return A2(
			_elm_lang$http$Http$send,
			_user$project$Types$SaveNewTrades,
			A4(
				_user$project$Rest$customRequest,
				'POST',
				url,
				...
				_elm_lang$http$Http$jsonBody(
					_user$project$Rest$tradeValue(trades))));
	};
	var _user$project$Rest$fetchTrades = function () {
		var url = 'https://magnetis-trades.herokuapp.com/trades.json';
		return A2(
			_elm_lang$http$Http$send,
			_user$project$Types$ReceiveTrades,
			A2(_elm_lang$http$Http$get, url, _user$project$Rest$decodeTrades));
	}();

	var _user$project$Main$subscriptions = function (model) {
		return A2(
			_mdgriffith$elm_style_animation$Animation$subscription,
			_user$project$Types$Animate,
			{
				ctor: '::',
				_0: model.loadingStyle,
				_1: {ctor: '[]'}
			});
	};
	var _user$project$Main$hideLoading = function (model) {
		return A2(
	...
	var _user$project$Main$showLoading = function (model) {
		return A2(
			_mdgriffith$elm_style_animation$Animation$interrupt,
			{
				ctor: '::',
	...
	var _user$project$Main$changeTrade = F3(
		function (idx, trade, trades) {
			return A2(
				_elm_lang$core$Basics_ops['++'],
				A2(_elm_lang$core$List$take, idx, trades),
				A2(
					_elm_lang$core$Basics_ops['++'],
					{
						ctor: '::',
					...
					A2(_elm_lang$core$List$drop, idx + 1, trades)));
		});
	var _user$project$Main$update = F2(
		function (message, model) {
			...
			switch (_p0.ctor) {
				case 'FetchTrades':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								loadingStyle: _user$project$Main$showLoading(model)
							}),
						_1: _user$project$Rest$fetchTrades
					};
				case 'SaveTrades':
					var trades = A2(
						_elm_lang$core$List$filter,
						function (t) {
							return _elm_lang$core$Native_Utils.eq(t.id, -1);
						},
						model.trades);
					return _elm_lang$core$Native_Utils.eq(
						_elm_lang$core$List$length(trades),
						...
						_1: _user$project$Rest$saveNewTrades(trades)
					};
				case 'ReceiveTrades':
					if (_p0._0.ctor === 'Ok') {
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									trades: A2(
										...
										_p0._0._0),
									loadingStyle: _user$project$Main$hideLoading(model)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					} else {
						var t = A2(_elm_lang$core$Debug$log, 'Erro: ', _p0._0._0);
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
				...
				case 'SaveNewTrades':
					if (_p0._0.ctor === 'Ok') {
						var l = A2(_elm_lang$core$Debug$log, 'json value: ', _p0._0._0);
						return {ctor: '_Tuple2', _0: model, _1: _user$project$Rest$fetchTrades};
					} else {
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
				...
				case 'TypeShareValue':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								shareValue: _user$project$Utils$currencyToFloat(_p0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'AddTrade':
					var trades = A2(
						...
						{
							ctor: '::',
							_0: _user$project$Types$newTrade,
							_1: {ctor: '[]'}
						});
					return {
						ctor: '_Tuple2',
				...
				case 'RemoveTrade':
					var _p3 = _p0._0;
					var tradeToRemove = _elm_lang$core$List$head(
						A2(_elm_lang$core$List$drop, _p3, model.trades));
					var trades = A2(
						_elm_lang$core$Basics_ops['++'],
						A2(_elm_lang$core$List$take, _p3, model.trades),
						A2(_elm_lang$core$List$drop, _p3 + 1, model.trades));
					var _p1 = tradeToRemove;
					if (_p1.ctor === 'Nothing') {
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					} else {
						var _p2 = _p1._0;
						return _elm_lang$core$Native_Utils.eq(_p2.id, -1) ? {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{trades: trades}),
							...
							_1: _user$project$Rest$deleteTrade(_p2.id)
						};
					}
				case 'TradeRemoved':
					if (_p0._0.ctor === 'Ok') {
				...
				case 'ChangeKind':
					...
					var _p4 = _elm_lang$core$List$head(
						A2(_elm_lang$core$List$drop, _p5, model.trades));
					if (_p4.ctor === 'Nothing') {
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					} else {
						var newTrade = _elm_lang$core$Native_Utils.update(
							_p4._0,
							{
								kind: A2(
									_elm_lang$core$Result$withDefault,
						...
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									trades: A3(_user$project$Main$changeTrade, _p5, newTrade, model.trades)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					}
				case 'TypeShares':
					...
					var _p6 = _elm_lang$core$List$head(
						A2(_elm_lang$core$List$drop, _p7, model.trades));
					if (_p6.ctor === 'Nothing') {
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					} else {
						var newTrade = _elm_lang$core$Native_Utils.update(
							_p6._0,
							{
								shares: A2(
									...
									_elm_lang$core$String$toFloat(
										A2(_elm_lang$core$String$filter, _elm_lang$core$Char$isDigit, _p0._1)))
							});
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									trades: A3(_user$project$Main$changeTrade, _p7, newTrade, model.trades)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					}
				case 'TypeDate':
					...
					var _p8 = _elm_lang$core$List$head(
						A2(_elm_lang$core$List$drop, _p9, model.trades));
					if (_p8.ctor === 'Nothing') {
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					} else {
						var newTrade = _elm_lang$core$Native_Utils.update(
							_p8._0,
							{
								date: _user$project$Utils$brazilianDateToServerDate(_p0._1)
							});
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									trades: A3(_user$project$Main$changeTrade, _p9, newTrade, model.trades)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					}
				default:
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								loadingStyle: A2(_mdgriffith$elm_style_animation$Animation$update, _p0._0, model.loadingStyle)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
			}
		});
	var _user$project$Main$init = {ctor: '_Tuple2', _0: _user$project$Types$initModel, _1: _user$project$Rest$fetchTrades};
	var _user$project$Main$main = _elm_lang$html$Html$program(
		{init: _user$project$Main$init, update: _user$project$Main$update, subscriptions: _user$project$Main$subscriptions, view: _user$project$View$view})();
